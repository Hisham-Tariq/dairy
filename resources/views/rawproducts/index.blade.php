...
<div class="p-6">
    ...
    <div class="card p-6 mb-6">
        <form method="GET" action="{{ route('rawproducts.index') }}">
...
function openCreateModal() {
    ...
    document.getElementById('productForm').action = '{{ route('rawproducts.store') }}';
...
function openEditModal(product) {
    ...
    document.getElementById('productForm').action = `/rawproducts/${product.id}`;
