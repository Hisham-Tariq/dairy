...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-secondary-900 mb-2">Record Production</h1>
                <p class="text-secondary-600">Add a new production record to your dairy management system.</p>
            </div>
    ...
    <div class="card max-w-2xl mx-auto">
        <form method="POST" action="{{ route('produced-products.store') }}">
            @csrf
            <div class="p-6">
                <div class="mb-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-secondary-500">Record the production information</p>
                        </div>
                    </div>
                </div>
